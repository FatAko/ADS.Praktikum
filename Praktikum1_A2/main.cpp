...
int main(void)
{
    ...
    // Tests für die Funktionen insertFront(int key) & insertBack(int key)
    for (i = 0; i < 10; i++)
    {
    ...
    //Tests für die Funktion search(int key)
    ...
    // Tests für die Funktion getBack(int key)

    while (MyList.getBack(i))
        cout << i << " ";
    cout << endl << endl;

    for (i = 0; i < 10; i++) // Liste wieder "auffüllen"
    {
        MyList.insertFront(i + 1);
        MyList.insertBack(i + 100);
    }

    // Tests für die Funktion getFront(int key)
    ...
    // Tests für die Funktion swap(int key1,int key2)
    MyList3.swap(8, 103);
    MyList3.swap(100, -111);

    cout << MyList3;

    // Test für die Funktion del(int key)
    MyList3.del(10);
    MyList3.del(100);
    MyList3.del(109);
    ...
    // Tests für die  Funktionen insertFront(list) und insertBack(list)
