...
TreeNode::TreeNode(int nodeOrderID, int nodeChronologicalID, std::string name, int age, double income, int postCode) : nodeOrderID{ nodeOrderID }, nodeChronologicalID{ nodeChronologicalID }, name{ name }, age{ age }, income{ income }, postCode{ postCode } {};
